		...
		<security:authorize access="hasRole('ADMIN')">
			<li><a class="fNiv"><spring:message	code="master.page.administrator" /></a>
				<ul>
					...
					<li><a href="company/admin/create.do"><spring:message code="master.page.registerCompany" /></a></li>					
				</ul>
			</li>
		</security:authorize>
		...
		<security:authorize access="isAuthenticated()">
			<li>
				...
				<ul>
					...
					<li><a href="logout"><spring:message code="master.page.logout" /> </a></li>
				</ul>
			</li>
		</security:authorize>
	</ul>
...
<div>
	<img src="images/logo routeGo.jpg" alt="logoRouteGo" height="200" width="500"/>
</div>
